	...
	<div class="container">
		...
		<div class="navbar-collapse collapse" id="navbar-main">
        	<ul class="nav navbar-nav">
        		<li><a href="<?php echo base_url(); ?>user/dashboard"><i class="glyphicon glyphicon-home"> </i> Beranda</a></li>
				<li class="dropdown">
            		...
            		<ul class="dropdown-menu open" aria-labelledby="themes">
            			<li><a tabindex="-1" href="<?php echo base_url(); ?>user/suratmasuk"> Surat Masuk <span class="badge" style="background-color: #fff; color: #822923; font-weight: bold;"><?php echo $total_surat;?> new</span></a></li>
              		</ul>
            	</li>
        	</ul>
