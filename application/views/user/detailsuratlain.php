	...
	<div class="col-lg-6">
		...
		<table width="100%" class="table-form">
			...
			<tr>
				...
				<td>
					<a href="<?php echo base_url();?>user/disposisi/lihatdisposisi/<?php echo $row->no_agenda;?>" target="_blank">Baca Disposisi</a>
				</td>
			</tr>
			<tr><td>&nbsp;</td></tr>
			<tr><td>&nbsp;</td></tr>
			<tr>
				<td colspan="2" style="text-align: right;">
					<a href="<?php echo base_url();?>user/disposisi/suratlain/<?php echo $row->no_agenda;?>" class="btn btn-success"><i class="glyphicon glyphicon-pencil"></i> Disposisi</a>
