...
<div class="row well">
	...
	<form action="<?php echo base_url();?>user/rubahpassword/change_successfully" method="post" accept-charset="utf-8" enctype="multipart/form-data">
		<div class="col-lg-6">
			<table width="100%" class="table-form">
				...
				<tr>
					<td colspan="2" style="text-align: right;">
						...
						<a href="<?php echo base_url();?>user/dashboard" class="btn btn-danger"><i class="glyphicon glyphicon-remove"></i> Batal</a>
					</td>
				</tr>
			</table>
		</div>
