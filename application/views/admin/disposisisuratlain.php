...
<div class="row well">
	<form action="<?php echo base_url();?>admin/disposisi/add_new_disposisi_lain" method="post" accept-charset="utf-8" enctype="multipart/form-data">
		<?php if($surat_masuk->num_rows()>0){?>
		...
		<div class="col-lg-6">
			<table width="100%" class="table-form">
				<tr>
					...
					<td><b><input type="hidden" name="disdari" value="<?php echo $row->dari;?>"><input type="hidden" name="disuntuk" value="<?php echo $row->teruskan;?>"><input type="hidden" name="dari" value="<?php echo $row->teruskan;?>"><input type="hidden" name="asalsurat" required style="width: 300px;" class="form-control" autofocus value="<?php echo $row->asal_surat;?>"><?php echo $row->asal_surat;?></b></td>
				</tr>
				<tr><td>&nbsp;</td></tr>
				<tr><td>&nbsp;</td></tr>
				<tr><td>&nbsp;</td></tr>
