	...
	<div class="container">
		...
		<div class="navbar-collapse collapse" id="navbar-main">
        	<ul class="nav navbar-nav">
        		<li><a href="<?php echo base_url(); ?>admin/dashboard"><i class="glyphicon glyphicon-home"> </i> Beranda</a></li>
				<li class="dropdown">
            		<a class="dropdown-toggle" data-toggle="dropdown" href="#" id="themes"><i class="glyphicon glyphicon-random"> </i> Catat Surat <span class="caret"></span></a>
            		<ul class="dropdown-menu open" aria-labelledby="themes">
            			<li><a tabindex="-1" href="<?php echo base_url(); ?>admin/suratmasuk"> Surat Masuk</a></li>
                		<li><a tabindex="-1" href="<?php echo base_url(); ?>admin/disposisi"> Surat Keluar</a></li>
              		</ul>
            	</li>
            	<li class="dropdown">
            		<a class="dropdown-toggle" data-toggle="dropdown" href="#" id="themes"><i class="glyphicon glyphicon-search"> </i> Cari Surat <span class="caret"></span></a>
            		<ul class="dropdown-menu open" aria-labelledby="themes">
            			<li><a tabindex="-1" href="<?php echo base_url(); ?>admin/carisurat"> Pencarian Surat</a></li>
              		</ul>
            	</li>
				<li class="dropdown">
            		<a class="dropdown-toggle" data-toggle="dropdown" href="#" id="themes"><i class="glyphicon glyphicon-print"> </i> Cetak <span class="caret"></span></a>
            		<ul class="dropdown-menu open" aria-labelledby="themes">
            			<li><a tabindex="-1" href="<?php echo base_url(); ?>admin/cetak"> Cetak Agenda</a></li>
              		</ul>
            	</li>
        	</ul>
				...
				<li class="dropdown">
            		<a class="dropdown-toggle" data-toggle="dropdown" href="#" id="themes"><i class="glyphicon glyphicon-user"></i> <?php echo $logged_in['name'];?> <strong>[<?php echo $logged_in['rank'];?>]</strong> <span class="caret"></span></a>
              		<ul class="dropdown-menu" aria-labelledby="themes">
                		<li><a href="<?php echo base_url(); ?>admin/rubahpassword">Rubah Password</a></li>
