...
<div class="row well">
	<form action="<?php echo base_url();?>tatausaha/disposisi/add_new_disposisi" method="post" accept-charset="utf-8" enctype="multipart/form-data">
		...
		<?php if($row->tujuan=='Sekretaris Daerah'){?>
		<div class="col-lg-6">
		...
		<?php } else if($row->tujuan=='Asisten Adm. Pemerintah dan Kesra'){?>
		<div class="col-lg-6">
			<table width="100%" class="table-form">
				<tr>
					<td width="20%"><b>Asal Surat :</b></td>
		...
		<?php } else if($row->tujuan=='ASISTEN PEREKONOMIAN DAN PEMBANGUNAN'){?>
		<div class="col-lg-6">
			<table width="100%" class="table-form">
				<tr>
					<td width="20%"><b>Asal Surat :</b></td>
		...
		<?php } else if($row->tujuan=='ASISTEN ADMINSITRASI UMUM'){?>
		<div class="col-lg-6">
			<table width="100%" class="table-form">
				<tr>
					<td width="20%"><b>Asal Surat :</b></td>
