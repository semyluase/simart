	...
	<tbody>
		...
		?>
			<tr>
				...
				<td class="ctr">
					<div class="btn-group">
						<a href="<?php echo base_url();?>tatausaha/suratmasuk/detail/<?php echo $row->no_agenda;?>" class="btn btn-success btn-sm"><i class="glyphicon glyphicon-pencil"></i> Lihat Detail</a>
					</div>
				</td>
			</tr>
		<?php $no++;}}?>
	...
	<tbody>
		...
		?>
			<tr>
				...
				<td class="ctr">
					<div class="btn-group">
						<a href="<?php echo base_url();?>tatausaha/suratmasuk/detailkeluar/<?php echo $row->no_agenda;?>" class="btn btn-success btn-sm"><i class="glyphicon glyphicon-pencil"></i> Lihat Detail</a>
					</div>
				</td>
			</tr>
		<?php $no++;}}?>
