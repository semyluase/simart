		...
		<table width="100%" class="table-form">
			...
			<tr>
				<td colspan="2" style="text-align: right;">
					<a href="<?php echo base_url();?>tatausaha/disposisi/disposisilain/<?php echo $row->no_agenda;?>" class="btn btn-success"><i class="glyphicon glyphicon-pencil"></i> Disposisi</a>
